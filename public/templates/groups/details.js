...
(function (factory) {
  ...
  function compiled(helpers, context, guard, iter, helper) {
    ...
    return "<div component=\"groups/container\" class=\"groups details row\">\r\n\t<div component=\"groups/cover\" style=\"background-image: url(" + 
      __escape(guard(context && context['group'] && context['group']['cover:url'])) + 
      "); background-position: " + 
      __escape(guard(context && context['group'] && context['group']['cover:position'])) + 
      ";\">\r\n\t\t" + 
      ...
      (guard(context && context['group'] && context['group']['private']) ?
        "<span class=\"label label-info\">[[groups:details.private]]</span>" :
        "") + 
      "\r\n\t\t\t\t\t" + 
      (guard(context && context['group'] && context['group']['hidden']) ?
        "<span class=\"label label-info\">[[groups:details.hidden]]</span>&nbsp;" :
        "") + 
      "\r\n\t\t\t\t</h3>\r\n\t\t\t</div>\r\n\t\t\t<div class=\"panel-body\">\r\n\t\t\t\t<h1>" + 
      __escape(guard(context && context['group'] && context['group']['displayName'])) + 
      "</h1>\r\n\t\t\t\t<p>" + 
      __escape(guard(context && context['group'] && context['group']['descriptionParsed'])) + 
      "</p>\r\n\t\t\t\t" + 
      (guard(context && context['isAdmin']) ?
        "\r\n\t\t\t\t<div class=\"pull-right\">\r\n\t\t\t\t\t<a href=\"" + 
          __escape(guard(context && context['config'] && context['config']['relative_path'])) + 
          "/admin/manage/groups/" + 
          __escape(guard(context && context['group'] && context['group']['nameEncoded'])) + 
          "\" target=\"_blank\" class=\"btn btn-info\"><i class=\"fa fa-gear\"></i> [[user:edit]]</a>\r\n\t\t\t\t</div>\r\n\t\t\t\t" :
        "") + 
      "\r\n\t\t\t\t" + 
      (guard(context && context['loggedIn']) ?
        "\r\n\t\t\t\t<div class=\"pull-right\">\r\n\t\t\t\t\t" + 
          __escape(helper(context, helpers, 'membershipBtn', [guard(context && context['group'])])) + 
          "&nbsp;\r\n\t\t\t\t</div>\r\n\t\t\t\t" :
        "") + 
      ...
      (guard(context && context['group'] && context['group']['isOwner']) ?
        "\r\n\t\t<div class=\"panel panel-default\">\r\n\t\t\t<div class=\"panel-heading\">\r\n\t\t\t\t<h3 class=\"panel-title clearfix\">\r\n\t\t\t\t\t<i class=\"fa fa-clock-o\"></i> [[groups:details.pending]]\r\n\t\t\t\t\t" + 
          (guard(context && context['group'] && context['group']['pending'] && context['group']['pending']['length']) ?
          ...
          (guard(context && context['group'] && context['group']['invited'] && context['group']['invited']['length']) ?
            "" :
          ...
          (guard(context && context['group'] && context['group']['system']) ?
            "readonly" :
            "") + 
          ...
          __escape(guard(context && context['group'] && context['group']['description'])) + 
          ...
          compiled.blocks['group.categories'](helpers, context, guard, iter, helper) + 
          ...
          __escape(guard(context && context['group'] && context['group']['userTitleEscaped'])) + 
          "\"" + 
          (guard(context && context['group'] && context['group']['userTitleEnabled']) ?
            "" :
            " disabled") + 
          ...
          (guard(context && context['group'] && context['group']['userTitleEnabled']) ?
            ...
            " hide") + 
          "\" style=\"color: " + 
          __escape(guard(context && context['group'] && context['group']['textColor'])) + 
          "; background-color: " + 
          __escape(guard(context && context['group'] && context['group']['labelColor'])) + 
          "\"><i class=\"fa" + 
          (guard(context && context['group'] && context['group']['icon']) ?
            " " + 
              __escape(guard(context && context['group'] && context['group']['icon'])) :
            "") + 
          "\"></i> <span class=\"label-text\">" + 
          (guard(context && context['group'] && context['group']['userTitle']) ?
            __escape(guard(context && context['group'] && context['group']['userTitle'])) :
            __escape(guard(context && context['group'] && context['group']['displayName']))) + 
          ...
          (guard(context && context['group'] && context['group']['labelColor']) ?
            __escape(guard(context && context['group'] && context['group']['labelColor'])) :
            "") + 
          ...
          (guard(context && context['group'] && context['group']['textColor']) ?
            __escape(guard(context && context['group'] && context['group']['textColor'])) :
            "") + 
  ...
  compiled.blocks = {
    ...
    'group.pending': function grouppending(helpers, context, guard, iter, helper) {
      var __escape = helpers.__escape;
      var value = context;
      return iter(guard(context && context['group'] && context['group']['pending']), function each(key0, index, length, value) {
        var key = key0;
        return "\r\n\t\t\t\t\t<tr data-uid=\"" + 
          __escape(guard(context && context['group'] && context['group']['pending'] && context['group']['pending'][key0] && context['group']['pending'][key0]['uid'])) + 
          "\">\r\n\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t<a href=\"" + 
          __escape(guard(context && context['config'] && context['config']['relative_path'])) + 
          "/user/" + 
          __escape(guard(context && context['group'] && context['group']['pending'] && context['group']['pending'][key0] && context['group']['pending'][key0]['userslug'])) + 
          "\">" + 
          __escape(helper(context, helpers, 'buildAvatar', [guard(context && context['group'] && context['group']['pending'] && context['group']['pending'][key0]), "sm", guard(context && context['true'])])) + 
          "</a>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t<td class=\"member-name\">\r\n\t\t\t\t\t\t\t<a href=\"" + 
          __escape(guard(context && context['config'] && context['config']['relative_path'])) + 
          "/user/" + 
          __escape(guard(context && context['group'] && context['group']['pending'] && context['group']['pending'][key0] && context['group']['pending'][key0]['userslug'])) + 
          "\">" + 
          __escape(guard(context && context['group'] && context['group']['pending'] && context['group']['pending'][key0] && context['group']['pending'][key0]['username'])) + 
    ...
    'group.invited': function groupinvited(helpers, context, guard, iter, helper) {
      var __escape = helpers.__escape;
      var value = context;
      return iter(guard(context && context['group'] && context['group']['invited']), function each(key0, index, length, value) {
        var key = key0;
        return "\r\n\t\t\t\t\t<tr data-uid=\"" + 
          __escape(guard(context && context['group'] && context['group']['invited'] && context['group']['invited'][key0] && context['group']['invited'][key0]['uid'])) + 
          "\">\r\n\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t<a href=\"" + 
          __escape(guard(context && context['config'] && context['config']['relative_path'])) + 
          "/user/" + 
          __escape(guard(context && context['group'] && context['group']['invited'] && context['group']['invited'][key0] && context['group']['invited'][key0]['userslug'])) + 
          "\">" + 
          __escape(helper(context, helpers, 'buildAvatar', [guard(context && context['group'] && context['group']['invited'] && context['group']['invited'][key0]), "sm", guard(context && context['true'])])) + 
          "</a>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t<td class=\"member-name\">\r\n\t\t\t\t\t\t\t<a href=\"" + 
          __escape(guard(context && context['config'] && context['config']['relative_path'])) + 
          "/user/" + 
          __escape(guard(context && context['group'] && context['group']['invited'] && context['group']['invited'][key0] && context['group']['invited'][key0]['userslug'])) + 
          "\">" + 
          __escape(guard(context && context['group'] && context['group']['invited'] && context['group']['invited'][key0] && context['group']['invited'][key0]['username'])) + 
          "</a>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t<td>\r\n\t\t\t\t\t\t\t<div class=\"btn-group pull-right\">\r\n\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-default btn-sm dropdown-toggle\" data-toggle=\"dropdown\" aria-expanded=\"false\">\r\n\t\t\t\t\t\t\t\t\t[[global:more]] <span class=\"caret\"></span>\r\n\t\t\t\t\t\t\t\t</button>\r\n\t\t\t\t\t\t\t\t<ul class=\"dropdown-menu\" role=\"menu\">\r\n\t\t\t\t\t\t\t\t\t<li><a href=\"#\" data-ajaxify=\"false\" data-action=\"rescindInvite\">[[groups:invited.uninvite]]</a></li>\r\n\t\t\t\t\t\t\t\t</ul>\r\n\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t</td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t\t";
      }, function alt() {
        return "";
      });
    },
    'group.categories': function groupcategories(helpers, context, guard, iter, helper) {
      var __escape = helpers.__escape;
      var value = context;
      return iter(guard(context && context['group'] && context['group']['categories']), function each(key0, index, length, value) {
        var key = key0;
        return "\r\n\t\t\t\t\t\t\t<option value=\"" + 
          __escape(guard(context && context['group'] && context['group']['categories'] && context['group']['categories'][key0] && context['group']['categories'][key0]['cid'])) + 
          "\"" + 
          (guard(context && context['group'] && context['group']['categories'] && context['group']['categories'][key0] && context['group']['categories'][key0]['selected']) ?
            " selected" :
            "") + 
          ">\r\n\t\t\t\t\t\t\t\t" + 
          __escape(guard(context && context['group'] && context['group']['categories'] && context['group']['categories'][key0] && context['group']['categories'][key0]['level'])) + 
          __escape(guard(context && context['group'] && context['group']['categories'] && context['group']['categories'][key0] && context['group']['categories'][key0]['name'])) + 
          "\r\n\t\t\t\t\t\t\t</option>\r\n\t\t\t\t\t\t\t";
      }, function alt() {
        return "";
      });
    ...
    'widgets.left': function widgetsleft(helpers, context, guard, iter, helper) {
      var __escape = helpers.__escape;
      var value = context;
      return iter(guard(context && context['widgets'] && context['widgets']['left']), function each(key0, index, length, value) {
        var key = key0;
        return "\r\n\t\t\t" + 
          guard(context && context['widgets'] && context['widgets']['left'] && context['widgets']['left'][key0] && context['widgets']['left'][key0]['html']) + 
          "\r\n\t\t\t";
      }, function alt() {
        return "";
      });
    ...
    'widgets.right': function widgetsright(helpers, context, guard, iter, helper) {
      var __escape = helpers.__escape;
      var value = context;
      return iter(guard(context && context['widgets'] && context['widgets']['right']), function each(key0, index, length, value) {
        var key = key0;
        return "\r\n\t\t\t" + 
          guard(context && context['widgets'] && context['widgets']['right'] && context['widgets']['right'][key0] && context['widgets']['right'][key0]['html']) + 
          "\r\n\t\t\t";
      }, function alt() {
        return "";
      });
