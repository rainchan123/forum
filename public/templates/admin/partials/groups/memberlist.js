    ...
    'group.members': function groupmembers(helpers, context, guard, iter, helper) {
      ...
      return iter(guard(context && context['group'] && context['group']['members']), function each(key0, index, length, value) {
        ...
        return "\n\t<tr data-uid=\"" + 
          ...
          "\">\n\t\t\t\t" + 
          (guard(context && context['group'] && context['group']['members'] && context['group']['members'][key0] && context['group']['members'][key0]['picture']) ?
            "\n\t\t\t\t<img class=\"avatar avatar-sm avatar-rounded\" src=\"" + 
              __escape(guard(context && context['group'] && context['group']['members'] && context['group']['members'][key0] && context['group']['members'][key0]['picture'])) + 
              "\" />\n\t\t\t\t" :
            "\n\t\t\t\t<div class=\"avatar avatar-sm avatar-rounded\" style=\"background-color: " + 
              __escape(guard(context && context['group'] && context['group']['members'] && context['group']['members'][key0] && context['group']['members'][key0]['icon:bgColor'])) + 
              ";\">" + 
              __escape(guard(context && context['group'] && context['group']['members'] && context['group']['members'][key0] && context['group']['members'][key0]['icon:text'])) + 
              "</div>\n\t\t\t\t") + 
