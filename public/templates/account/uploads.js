...
(function (factory) {
  ...
  function compiled(helpers, context, guard, iter, helper) {
    ...
    return "<div class=\"account\">\r\n\t" + 
      ...
      "</h1>\r\n\r\n        " + 
      (guard(context && context['privateUploads']) ?
      ...
      "\r\n\r\n\t\t" + 
      (guard(context && context['uploads'] && context['uploads']['length']) ?
        "" :
  ...
  compiled.blocks = {
    ...
    'uploads': function uploads(helpers, context, guard, iter, helper) {
      var __escape = helpers.__escape;
      var value = context;
      return iter(guard(context && context['uploads']), function each(key0, index, length, value) {
        var key = key0;
        return "\r\n                    <tr data-name=\"" + 
          __escape(guard(context && context['uploads'] && context['uploads'][key0] && context['uploads'][key0]['name'])) + 
          "\">\r\n                        <td>\r\n                            <a href=\"" + 
          __escape(guard(context && context['config'] && context['config']['relative_path'])) + 
          __escape(guard(context && context['uploads'] && context['uploads'][key0] && context['uploads'][key0]['url'])) + 
          "\">" + 
          __escape(guard(context && context['uploads'] && context['uploads'][key0] && context['uploads'][key0]['url'])) + 
