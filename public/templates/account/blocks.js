...
(function (factory) {
  ...
  compiled.blocks = {
    ...
    'edit': function edit(helpers, context, guard, iter, helper) {
      var __escape = helpers.__escape;
      var value = context;
      return iter(guard(context && context['edit']), function each(key0, index, length, value) {
        var key = key0;
        return "\r\n\t\t\t\t\t\t\t<li class=\"list-group-item clearfix\">\r\n\t\t\t\t\t\t\t\t<button class=\"btn btn-sm btn-primary pull-right\" data-uid=\"" + 
          __escape(guard(context && context['edit'] && context['edit'][key0] && context['edit'][key0]['uid'])) + 
          "\" data-action=\"toggle\">[[user:block_toggle]]</button>\r\n\t\t\t\t\t\t\t\t<div class=\"pull-left\">\r\n\t\t\t\t\t\t\t\t\t<a href=\"" + 
          __escape(guard(context && context['config'] && context['config']['relative_path'])) + 
          "/uid/" + 
          __escape(guard(context && context['edit'] && context['edit'][key0] && context['edit'][key0]['uid'])) + 
          "\">" + 
          __escape(helper(context, helpers, 'buildAvatar', [guard(context && context['edit'] && context['edit'][key0]), "sm", guard(context && context['true'])])) + 
          " " + 
          __escape(guard(context && context['edit'] && context['edit'][key0] && context['edit'][key0]['username'])) + 
          "</a>\r\n\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t</li>\r\n\t\t\t\t\t\t\t";
      }, function alt() {
        return "";
      });
